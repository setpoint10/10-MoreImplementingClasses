...
class CapitalT(object):
    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def set_colors(self, fill_color, outline_color):
        ...
        #        They should look exactly the same as each other.
        # ---------------------------------------------------------------------
        self.h_rect.fill_color=self.v_rect.fill_color=fill_color
        self.h_rect.outline_color=self.v_rect.outline_color=outline_color
    ...
    def move_by(self, dx, dy):
        ...
        # ---------------------------------------------------------------------
        self=CapitalT(rg.Point(self.v_rect.get_center().x+dx,self.v_rect.get_center().y+dy),self.v_rect.get_width(),self.h_rect.get_height(),self.h_rect.get_width())
